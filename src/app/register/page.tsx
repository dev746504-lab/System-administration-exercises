      ...
      <div className="flex min-h-screen items-center justify-center px-6">
        <div className="flex max-w-sm flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-ink-muted">
            Hồ sơ CSGD &quot;{form.institutionName}&quot; đang chờ Quản trị hệ thống duyệt. Bạn sẽ đăng nhập được ngay, nhưng cần chờ duyệt để thêm thành viên.
          </p>
    ...
    <div className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-sm text-ink-muted">Tạo tài khoản quản trị + hồ sơ CSGD, chờ hệ thống duyệt</p>
        </div>

        <form onSubmit={onSubmit} className="flex flex-col gap-4">
          <Field label="Họ tên người quản trị">
